    ...
    <form method="post" action="{{route('tambah.absensi')}}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <br>
                <input type="radio" name="buka_atau_tutup" value="buka" id="buka" @if($value->buka_atau_tutup==="buka") checked @endif>
                <label for="buka">Buka</label>
                <br>
                <input type="radio" name="buka_atau_tutup" value="tutup" id="tutup" @if($value->buka_atau_tutup==="tutup") checked @endif>
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <br>
                <input type="radio" name="buka_otomatis" value="iya" id="change_buka_otomatis" @if(old('buka_otomatis', $value->buka_otomatis)==="iya") checked @endif>
                <label for="change_buka_otomatis">Iya</label>
                <br>
                <input type="radio" name="buka_otomatis" value="tidak" id="change_buka_otomatis_to_no" @if(old('buka_otomatis', $value->buka_otomatis)==="tidak") checked @endif>
                <label for="change_buka_otomatis_to_no">Tidak</label>
                @error("buka_otomatis")
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <br>
                <input type="radio" name="tutup_otomatis" value="iya" id="change_tutup_otomatis" @if(old('tutup_otomatis', $value->tutup_otomatis)==="iya") checked @endif>
                <label for="change_tutup_otomatis">Iya</label>
                <br>
                <input type="radio" name="tutup_otomatis" value="tidak" id="change_tutup_otomatis_to_no" @if(old('tutup_otomatis', $value->tutup_otomatis)==="tidak") checked @endif>
                <label for="change_tutup_otomatis_to_no">Tidak</label>
...
<style>
    input[type="radio"] {
        ...
        width: 20px;
        height: 20px;
        border: 2px solid #8B4513; /* Warna cokelat */
        border-radius: 50%;
        outline: none;
        cursor: pointer;
        position: relative;
    ...
    input[type="radio"]:checked::before {
        ...
        height: 12px;
        border-radius: 50%;
        background: #8B4513; /* Warna cokelat */
        position: absolute;
        top: 50%;
        left: 50%;
